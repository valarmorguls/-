/* ************************************************************************
> File Name:     web_server1.c
> Author:        xupeng
> About:         
> Created Time:  Fri 24 Feb 2023 02:13:43 PM CST
> Description:   
 ************************************************************************/
#include <stdio.h>
#include <stdlib.h>
...
#if 0
	const char *html = "<html><head><title>hello http</title></head><body><H1>XUPENG</H1></body></html>\r\n\r\n";
	ev->length = sprintf(ev->buffer,
		"HTTP/1.1 200 OK\r\n\
		 Date: Thu, 24 Feb 2023 22:28:52 GMT\r\n\
...
int main(int argc, char *argv[]) {
	unsigned short port = SERVER_PORT; // listen 8000
	if (argc == 2) {
		port = atoi(argv[1]);
	}
